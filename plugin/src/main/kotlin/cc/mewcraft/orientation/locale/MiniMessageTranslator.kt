...
interface MiniMessageTranslator : Translator, Examinable {
    ...
    companion object {
        ...
        fun renderer(): TranslatableComponentRenderer<Locale> {
...
private class MiniMessageTranslatorImpl : MiniMessageTranslator {
    ...
    companion object {
        private val NAME = Key.key("sparrow", "main")
        val INSTANCE: MiniMessageTranslatorImpl = MiniMessageTranslatorImpl()
    }
}